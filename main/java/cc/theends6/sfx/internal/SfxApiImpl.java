...
public final class SfxApiImpl implements SfxApi {
    ...
    public static SfxApiImpl bootstrap(JavaPlugin plugin, SfxLocalization localization) {
        ...
        DefaultSfxGuide guide = new DefaultSfxGuide(plugin, runtime, itemRegistry, items, menus, new PermissionGuideAccessPolicy(), manualMachines, localization);
