...
final class LegacySfItemBootstrapPart1 {
    private LegacySfItemBootstrapPart1() {
    }
    ...
    static void register(SfxItemRegistry registry) {
        ...
        registerLegacyItem(registry, "sf:restored_backpack", "sf:backpacks", Material.PLAYER_HEAD, "&eRestored Backpack", "9c3681bf8a2738232fb305597f7e2a34a3a5c1356705249e9a365b0bcd04705a", null, new String[] {"", "&7Retrieve your lost items", "&7ID: <ID>", "", "&eRight Click&7 to open"}, true, false);
        registerLegacyItem(registry, "sf:duralumin_jetpack", "sf:jetpacks", Material.LEATHER_CHESTPLATE, "&9Electric Jetpack &7- &eI", null, 0x9D9D97, new String[] {"", "&8鈬?&7Material: &bDuralumin", "&8鈬?&e鈿?&70 / 20 J", "&8鈬?&7Thrust: &c0.35", "", "&eCrouch&7 to use"});
        registerLegacyItem(registry, "sf:solder_jetpack", "sf:jetpacks", Material.LEATHER_CHESTPLATE, "&9Electric Jetpack &7- &eII", null, 0x9D9D97, new String[] {"", "&8鈬?&7Material: &bSolder", "&8鈬?&e鈿?&70 / 30 J", "&8鈬?&7Thrust: &c0.4", "", "&eCrouch&7 to use"});
        registerLegacyItem(registry, "sf:billon_jetpack", "sf:jetpacks", Material.LEATHER_CHESTPLATE, "&9Electric Jetpack &7- &eIII", null, 0x9D9D97, new String[] {"", "&8鈬?&7Material: &bBillon", "&8鈬?&e鈿?&70 / 45 J", "&8鈬?&7Thrust: &c0.45", "", "&eCrouch&7 to use"});
        registerLegacyItem(registry, "sf:steel_jetpack", "sf:jetpacks", Material.LEATHER_CHESTPLATE, "&9Electric Jetpack &7- &eIV", null, 0x9D9D97, new String[] {"", "&8鈬?&7Material: &bSteel", "&8鈬?&e鈿?&70 / 60 J", "&8鈬?&7Thrust: &c0.5", "", "&eCrouch&7 to use"});
        registerLegacyItem(registry, "sf:damascus_steel_jetpack", "sf:jetpacks", Material.LEATHER_CHESTPLATE, "&9Electric Jetpack &7- &eV", null, 0x9D9D97, new String[] {"", "&8鈬?&7Material: &bDamascus Steel", "&8鈬?&e鈿?&70 / 75 J", "&8鈬?&7Thrust: &c0.55", "", "&eCrouch&7 to use"});
        registerLegacyItem(registry, "sf:reinforced_alloy_jetpack", "sf:jetpacks", Material.LEATHER_CHESTPLATE, "&9Electric Jetpack &7- &eVI", null, 0x9D9D97, new String[] {"", "&8鈬?&7Material: &bReinforced Alloy", "&8鈬?&e鈿?&70 / 100 J", "&8鈬?&7Thrust: &c0.6", "", "&eCrouch&7 to use"});
        registerLegacyItem(registry, "sf:carbonado_jetpack", "sf:jetpacks", Material.LEATHER_CHESTPLATE, "&9Electric Jetpack &7- &eVII", null, 0x1D1D21, new String[] {"", "&8鈬?&7Material: &bCarbonado", "&8鈬?&e鈿?&70 / 150 J", "&8鈬?&7Thrust: &c0.7", "", "&eCrouch&7 to use"});
        registerLegacyItem(registry, "sf:armored_jetpack", "sf:jetpacks", Material.IRON_CHESTPLATE, "&9Armored Jetpack", null, null, new String[] {"&8鈬?&7Material: &bSteel", "", "&8鈬?&e鈿?&70 / 50 J", "&8鈬?&7Thrust: &c0.5", "", "&eCrouch&7 to use"});
        registerLegacyItem(registry, "sf:duralumin_jetboots", "sf:jetboots", Material.LEATHER_BOOTS, "&9Jet Boots &7- &eI", null, 0x9D9D97, new String[] {"", "&8鈬?&7Material: &bDuralumin", "&8鈬?&e鈿?&70 / 20 J", "&8鈬?&b鈿?&7Speed: &b0.35x", "&8鈬?&7Accuracy: &c50%", "", "&eCrouch&7 to use"});
        registerLegacyItem(registry, "sf:solder_jetboots", "sf:jetboots", Material.LEATHER_BOOTS, "&9Jet Boots &7- &eII", null, 0x9D9D97, new String[] {"", "&8鈬?&7Material: &bSolder", "&8鈬?&e鈿?&70 / 30 J", "&8鈬?&b鈿?&7Speed: &b0.4x", "&8鈬?&7Accuracy: &660%", "", "&eCrouch&7 to use"});
        registerLegacyItem(registry, "sf:billon_jetboots", "sf:jetboots", Material.LEATHER_BOOTS, "&9Jet Boots &7- &eIII", null, 0x9D9D97, new String[] {"", "&8鈬?&7Material: &bBillon", "&8鈬?&e鈿?&70 / 40 J", "&8鈬?&b鈿?&7Speed: &b0.45x", "&8鈬?&7Accuracy: &665%", "", "&eCrouch&7 to use"});
        registerLegacyItem(registry, "sf:steel_jetboots", "sf:jetboots", Material.LEATHER_BOOTS, "&9Jet Boots &7- &eIV", null, 0x9D9D97, new String[] {"", "&8鈬?&7Material: &bSteel", "&8鈬?&e鈿?&70 / 50 J", "&8鈬?&b鈿?&7Speed: &b0.5x", "&8鈬?&7Accuracy: &e70%", "", "&eCrouch&7 to use"});
        registerLegacyItem(registry, "sf:damascus_steel_jetboots", "sf:jetboots", Material.LEATHER_BOOTS, "&9Jet Boots &7- &eV", null, 0x9D9D97, new String[] {"", "&8鈬?&7Material: &bDamascus Steel", "&8鈬?&e鈿?&70 / 75 J", "&8鈬?&b鈿?&7Speed: &b0.55x", "&8鈬?&7Accuracy: &a75%", "", "&eCrouch&7 to use"});
        registerLegacyItem(registry, "sf:reinforced_alloy_jetboots", "sf:jetboots", Material.LEATHER_BOOTS, "&9Jet Boots &7- &eVI", null, 0x9D9D97, new String[] {"", "&8鈬?&7Material: &bReinforced Alloy", "&8鈬?&e鈿?&70 / 100 J", "&8鈬?&b鈿?&7Speed: &b0.6x", "&8鈬?&7Accuracy: &c80%", "", "&eCrouch&7 to use"});
        registerLegacyItem(registry, "sf:carbonado_jetboots", "sf:jetboots", Material.LEATHER_BOOTS, "&9Jet Boots &7- &eVII", null, 0x1D1D21, new String[] {"", "&8鈬?&7Material: &bCarbonado", "&8鈬?&e鈿?&70 / 125 J", "&8鈬?&b鈿?&7Speed: &b0.7x", "&8鈬?&7Accuracy: &c99.9%", "", "&eCrouch&7 to use"});
        registerLegacyItem(registry, "sf:armored_jetboots", "sf:jetboots", Material.IRON_BOOTS, "&9Armored Jet Boots", null, null, new String[] {"", "&8鈬?&7Material: &bSteel", "&8鈬?&e鈿?&70 / 50 J", "&8鈬?&b鈿?&7Speed: &b0.45x", "&8鈬?&7Accuracy: &e70%", "", "&eCrouch&7 to use"});
        registerLegacyItem(registry, "sf:duralumin_multi_tool", "sf:multi_tools", Material.SHEARS, "&9Multi Tool &7- &eI", null, null, new String[] {"", "&8鈬?&7Material: &bDuralumin", "&8鈬?&e鈿?&70 / 20 J", "", "&eRight Click&7 to use", "&eCrouch & Right Click&7 to switch modes"});
        registerLegacyItem(registry, "sf:solder_multi_tool", "sf:multi_tools", Material.SHEARS, "&9Multi Tool &7- &eII", null, null, new String[] {"", "&8鈬?&7Material: &bSolder", "&8鈬?&e鈿?&70 / 30 J", "", "&eRight Click&7 to use", "&eCrouch & Right Click&7 to switch modes"});
        registerLegacyItem(registry, "sf:billon_multi_tool", "sf:multi_tools", Material.SHEARS, "&9Multi Tool &7- &eIII", null, null, new String[] {"", "&8鈬?&7Material: &bBillon", "&8鈬?&e鈿?&70 / 40 J", "", "&eRight Click&7 to use", "&eCrouch & Right Click&7 to switch modes"});
        registerLegacyItem(registry, "sf:steel_multi_tool", "sf:multi_tools", Material.SHEARS, "&9Multi Tool &7- &eIV", null, null, new String[] {"", "&8鈬?&7Material: &bSteel", "&8鈬?&e鈿?&70 / 50 J", "", "&eRight Click&7 to use", "&eCrouch & Right Click&7 to switch modes"});
        registerLegacyItem(registry, "sf:damascus_steel_multi_tool", "sf:multi_tools", Material.SHEARS, "&9Multi Tool &7- &eV", null, null, new String[] {"", "&8鈬?&7Material: &bDamascus Steel", "&8鈬?&e鈿?&70 / 60 J", "", "&eRight Click&7 to use", "&eCrouch & Right Click&7 to switch modes"});
        registerLegacyItem(registry, "sf:reinforced_alloy_multi_tool", "sf:multi_tools", Material.SHEARS, "&9Multi Tool &7- &eVI", null, null, new String[] {"", "&8鈬?&7Material: &bReinforced Alloy", "&8鈬?&e鈿?&70 / 75 J", "", "&eRight Click&7 to use", "&eCrouch & Right Click&7 to switch modes"});
        registerLegacyItem(registry, "sf:carbonado_multi_tool", "sf:multi_tools", Material.SHEARS, "&9Multi Tool &7- &eVII", null, null, new String[] {"", "&8鈬?&7Material: &bCarbonado", "&8鈬?&e鈿?&70 / 100 J", "", "&eRight Click&7 to use", "&eCrouch & Right Click&7 to switch modes"});
