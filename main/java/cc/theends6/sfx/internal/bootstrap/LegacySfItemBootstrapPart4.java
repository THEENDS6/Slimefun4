...
final class LegacySfItemBootstrapPart4 {
    ...
    static void register(SfxItemRegistry registry) {
        ...
        registerLegacyItem(registry, "sf:iron_golem_assembler", "sf:electricity", Material.IRON_BLOCK, "&6Iron Golem Assembler", null, null, new String[] {"", "&4End-Game Machine", "&8⇨ &7Cooldown: &b30 Seconds", "&8⇨ &e⚡&781920 J Buffer", "&8⇨ &e⚡&72048 J/Golem"});
        registerLegacyItem(registry, "sf:wither_assembler", "sf:electricity", Material.OBSIDIAN, "&5Wither Assembler", null, null, new String[] {"", "&4End-Game Machine", "&8⇨ &7Cooldown: &b30 Seconds", "&8⇨ &e⚡&781920 J Buffer", "&8⇨ &e⚡&74096 J/Wither"});
