...
final class SfxElectricMachineDefinitions {
    ...
    static SfxElectricMachineRegistry create(JavaPlugin plugin, SfxItems items, DefaultManualMachineRegistry manualMachines, SfxBlockDataService blockData, SfxVirtualContainerService virtualContainers) {
        ...
        result.register(new SfxElectricMachineDefinition("sf:gps_transmitter", "GPS Transmitter", 1, 320, 2, Material.COMPASS, gpsTransmitterRecipes, SfxElectricMachineDefinition.NO_INPUT_SLOTS, SfxElectricMachineDefinition.NO_OUTPUT_SLOTS, SfxElectricMachineMenuStyle.NONE));
        result.register(new SfxElectricMachineDefinition("sf:gps_transmitter_2", "Advanced GPS Transmitter", 1, 1280, 6, Material.COMPASS, gpsTransmitterRecipes, SfxElectricMachineDefinition.NO_INPUT_SLOTS, SfxElectricMachineDefinition.NO_OUTPUT_SLOTS, SfxElectricMachineMenuStyle.NONE));
        result.register(new SfxElectricMachineDefinition("sf:gps_transmitter_3", "Carbonado GPS Transmitter", 1, 5120, 22, Material.COMPASS, gpsTransmitterRecipes, SfxElectricMachineDefinition.NO_INPUT_SLOTS, SfxElectricMachineDefinition.NO_OUTPUT_SLOTS, SfxElectricMachineMenuStyle.NONE));
        result.register(new SfxElectricMachineDefinition("sf:gps_transmitter_4", "Energized GPS Transmitter", 1, 20480, 92, Material.COMPASS, gpsTransmitterRecipes, SfxElectricMachineDefinition.NO_INPUT_SLOTS, SfxElectricMachineDefinition.NO_OUTPUT_SLOTS, SfxElectricMachineMenuStyle.NONE));
        result.register(new SfxElectricMachineDefinition("sf:geo_miner", "GEO Miner", 1, 512, 48, Material.DIAMOND_PICKAXE, geoMinerRecipes, SfxElectricMachineDefinition.NO_INPUT_SLOTS, SfxElectricMachineDefinition.GEO_MINER_OUTPUT_SLOTS, SfxElectricMachineMenuStyle.GEO_MINER));
        result.register(new SfxElectricMachineDefinition("sf:oil_pump", "Oil Pump", 1, 512, 24, Material.BUCKET, oilPumpRecipes));
