...
final class SfxElectricMachineDefinitions {
    ...
    static SfxElectricMachineRegistry create(JavaPlugin plugin, SfxItems items, DefaultManualMachineRegistry manualMachines, SfxBlockDataService blockData, SfxVirtualContainerService virtualContainers) {
        ...
        if (sfxAutoBrewer) {
            register(result, config, new SfxElectricMachineDefinition("sf:auto_brewer", "Auto Brewer", 1, buffer(512), 12, Material.BREWING_STAND, autoBrewerRecipes, SfxElectricMachineDefinition.AUTO_BREWER_INPUT_SLOTS, SfxElectricMachineDefinition.NO_OUTPUT_SLOTS, SfxElectricMachineMenuStyle.AUTO_BREWER));
            register(result, config, new SfxElectricMachineDefinition("sf:auto_brewer_2", "Auto Brewer II", 5, buffer(1024), 50, Material.BREWING_STAND, autoBrewerRecipes, SfxElectricMachineDefinition.AUTO_BREWER_INPUT_SLOTS, SfxElectricMachineDefinition.NO_OUTPUT_SLOTS, SfxElectricMachineMenuStyle.AUTO_BREWER));
        } else {
            register(result, config, new SfxElectricMachineDefinition("sf:auto_brewer", "Auto Brewer", 1, buffer(256), 12, Material.FISHING_ROD, autoBrewerRecipes));
        }

        register(result, config, new SfxElectricMachineDefinition("sf:vanilla_auto_crafter", "Auto-Crafter (Vanilla)", 1, 5120, 32, Material.CRAFTING_TABLE, vanillaAutoCrafterRecipes, SfxElectricMachineDefinition.NO_INPUT_SLOTS, SfxElectricMachineDefinition.NO_OUTPUT_SLOTS, SfxElectricMachineMenuStyle.AUTO_CRAFTER));
        register(result, config, new SfxElectricMachineDefinition("sf:enhanced_auto_crafter", "Auto-Crafter (Enhanced)", 1, 5120, 32, Material.CRAFTING_TABLE, enhancedAutoCrafterRecipes, SfxElectricMachineDefinition.NO_INPUT_SLOTS, SfxElectricMachineDefinition.NO_OUTPUT_SLOTS, SfxElectricMachineMenuStyle.AUTO_CRAFTER));
        register(result, config, new SfxElectricMachineDefinition("sf:armor_auto_crafter", "Auto-Crafter (Armor Forge)", 1, 5120, 64, Material.ANVIL, armorAutoCrafterRecipes, SfxElectricMachineDefinition.NO_INPUT_SLOTS, SfxElectricMachineDefinition.NO_OUTPUT_SLOTS, SfxElectricMachineMenuStyle.AUTO_CRAFTER));
        ...
        register(result, config, new SfxElectricMachineDefinition("sf:auto_breeder", "Auto Breeder", 1, buffer(1024), 60, Material.WHEAT, autoBreederRecipes, SfxElectricMachineDefinition.SIMPLE_IO_SLOTS, SfxElectricMachineDefinition.NO_OUTPUT_SLOTS, SfxElectricMachineMenuStyle.SIMPLE_IO));
        register(result, config, new SfxElectricMachineDefinition("sf:animal_growth_accelerator", "Animal Growth Accelerator", 1, buffer(1024), 14, Material.WHEAT, animalGrowthRecipes, SfxElectricMachineDefinition.SIMPLE_IO_SLOTS, SfxElectricMachineDefinition.NO_OUTPUT_SLOTS, SfxElectricMachineMenuStyle.SIMPLE_IO));
        register(result, config, new SfxElectricMachineDefinition("sf:crop_growth_accelerator", "Crop Growth Accelerator", 1, cropGrowthCapacity, cropGrowthEnergy, Material.BONE_MEAL, cropGrowthRecipes, SfxElectricMachineDefinition.SIMPLE_IO_SLOTS, SfxElectricMachineDefinition.NO_OUTPUT_SLOTS, SfxElectricMachineMenuStyle.SIMPLE_IO));
        register(result, config, new SfxElectricMachineDefinition("sf:crop_growth_accelerator_2", "Crop Growth Accelerator - II", 1, cropGrowthCapacity, cropGrowth2Energy, Material.BONE_MEAL, cropGrowth2Recipes, SfxElectricMachineDefinition.SIMPLE_IO_SLOTS, SfxElectricMachineDefinition.NO_OUTPUT_SLOTS, SfxElectricMachineMenuStyle.SIMPLE_IO));
        register(result, config, new SfxElectricMachineDefinition("sf:tree_growth_accelerator", "Tree Growth Accelerator", 1, treeGrowthCapacity, treeGrowthEnergy, Material.OAK_SAPLING, treeGrowthRecipes, SfxElectricMachineDefinition.SIMPLE_IO_SLOTS, SfxElectricMachineDefinition.NO_OUTPUT_SLOTS, SfxElectricMachineMenuStyle.SIMPLE_IO));
        register(result, config, new SfxElectricMachineDefinition("sf:xp_collector", "EXP Collector", 1, buffer(1024), 20, Material.EXPERIENCE_BOTTLE, expCollectorRecipes, SfxElectricMachineDefinition.NO_INPUT_SLOTS, SfxElectricMachineDefinition.SIMPLE_IO_SLOTS, SfxElectricMachineMenuStyle.SIMPLE_IO));
        ...
        register(result, config, new SfxElectricMachineDefinition("sf:gps_transmitter", "GPS Transmitter", 1, 320, 2, Material.COMPASS, gpsTransmitterRecipes, SfxElectricMachineDefinition.NO_INPUT_SLOTS, SfxElectricMachineDefinition.NO_OUTPUT_SLOTS, SfxElectricMachineMenuStyle.NONE));
        register(result, config, new SfxElectricMachineDefinition("sf:gps_transmitter_2", "Advanced GPS Transmitter", 1, 1280, 6, Material.COMPASS, gpsTransmitterRecipes, SfxElectricMachineDefinition.NO_INPUT_SLOTS, SfxElectricMachineDefinition.NO_OUTPUT_SLOTS, SfxElectricMachineMenuStyle.NONE));
        register(result, config, new SfxElectricMachineDefinition("sf:gps_transmitter_3", "Carbonado GPS Transmitter", 1, 5120, 22, Material.COMPASS, gpsTransmitterRecipes, SfxElectricMachineDefinition.NO_INPUT_SLOTS, SfxElectricMachineDefinition.NO_OUTPUT_SLOTS, SfxElectricMachineMenuStyle.NONE));
        register(result, config, new SfxElectricMachineDefinition("sf:gps_transmitter_4", "Energized GPS Transmitter", 1, 20480, 92, Material.COMPASS, gpsTransmitterRecipes, SfxElectricMachineDefinition.NO_INPUT_SLOTS, SfxElectricMachineDefinition.NO_OUTPUT_SLOTS, SfxElectricMachineMenuStyle.NONE));
        register(result, config, new SfxElectricMachineDefinition("sf:geo_miner", "GEO Miner", 1, 512, 48, Material.DIAMOND_PICKAXE, geoMinerRecipes, SfxElectricMachineDefinition.NO_INPUT_SLOTS, SfxElectricMachineDefinition.GEO_MINER_OUTPUT_SLOTS, SfxElectricMachineMenuStyle.GEO_MINER));
        ...
        register(result, config, new SfxElectricMachineDefinition("sf:iron_golem_assembler", "Iron Golem Assembler", 1, 81920, 75, Material.CARVED_PUMPKIN, ironGolemAssemblerRecipes, SfxElectricMachineDefinition.ASSEMBLER_INPUT_SLOTS, SfxElectricMachineDefinition.NO_OUTPUT_SLOTS, SfxElectricMachineMenuStyle.ASSEMBLER, ironGolemAssemblerSpec));
        register(result, config, new SfxElectricMachineDefinition("sf:wither_assembler", "Wither Assembler", 1, 81920, 150, Material.WITHER_SKELETON_SKULL, witherAssemblerRecipes, SfxElectricMachineDefinition.ASSEMBLER_INPUT_SLOTS, SfxElectricMachineDefinition.NO_OUTPUT_SLOTS, SfxElectricMachineMenuStyle.ASSEMBLER, witherAssemblerSpec));
