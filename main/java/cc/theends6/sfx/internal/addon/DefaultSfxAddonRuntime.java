...
public final class DefaultSfxAddonRuntime implements SfxAddonRuntime, AutoCloseable {
    ...
    private final SfxContinuousMachineRuntime continuous = new ContinuousRuntime();
    ...
    private final class ContinuousRuntime implements SfxContinuousMachineRuntime {
