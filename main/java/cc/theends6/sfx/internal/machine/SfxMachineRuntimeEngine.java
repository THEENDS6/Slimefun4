 ...
 *
 * <p>This is intentionally not a replacement for the concrete machine implementations. It is the
 * common runtime boundary that every machine-like system must pass through: definitions are
 * registered here, tick executions are wrapped here, runtime snapshots are recorded here, and
 * lifecycle placement/destruction records are cleaned here.</p>
 */
