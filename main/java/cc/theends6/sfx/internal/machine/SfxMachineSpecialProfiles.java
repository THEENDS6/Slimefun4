 ...
 *
 * <p>This class does not reimplement domain behavior. It makes special behavior visible to the
 * framework so runtime, audit, UI, inventory and future processors can reason about it without
 * burying everything inside one service class.</p>
 */
