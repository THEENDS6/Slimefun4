...
/** Shared lazy tick configuration for SFX machines. */
public final class SfxMachineTickSettings {
    ...
    private SfxMachineTickSettings(boolean enabled, int intervalTicks, int viewerIntervalTicks, int sleepingProbeIntervalTicks) {
    ...
    public static SfxMachineTickSettings from(FileConfiguration config) {
        ...
        return new SfxMachineTickSettings(enabled, interval, viewerInterval, sleepingProbeInterval);
    }
