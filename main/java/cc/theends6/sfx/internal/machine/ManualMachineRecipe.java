...
public final class ManualMachineRecipe {
    ...
    /**
     * Returns every possible output for guide display and recipe ownership.
     * Machine execution should use fixedOutputs() plus one selected random output when hasRandomOutputs() is true.
     */
