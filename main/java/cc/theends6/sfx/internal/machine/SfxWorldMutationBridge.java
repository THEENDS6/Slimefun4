 ...
 * directly. Unlike the earlier audit-only bridge, this version treats BEFORE_WORLD_MUTATION as a
 * real veto point and restores the previous block state when an AFTER hook asks for rollback.</p>
 */
