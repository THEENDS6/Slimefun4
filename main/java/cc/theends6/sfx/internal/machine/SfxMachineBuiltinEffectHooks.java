...
/**
 * Built-in framework implementations for declarative special-machine effects.
 *
 * <p>Domain services can still override these names with stricter implementations by calling
 * {@link SfxMachineRuntimeEngine#registerEffectHook(String, SfxMachineHook)}. The hooks in this
 * class make every special profile executable by the shared machine pipeline instead of leaving
 * profile effects as passive markers.</p>
 */
