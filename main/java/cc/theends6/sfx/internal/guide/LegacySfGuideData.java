...
final class LegacySfGuideData {
    private LegacySfGuideData() {
    }

static Map<String, String> createExactCategoryByItem() {
...
static Map<String, String> createSourceCategoryFallbacks() {
    Map<String, String> map = new LinkedHashMap<>();
...
static Map<String, SfxItemCategory> createVirtualCategories() {
...
static Map<String, Integer> createClassicArmorOrder() {
    Map<String, Integer> map = new LinkedHashMap<>();
    int order = 10;
    order = putRange(map, order,
...
static Map<String, List<String>> createLockedCategoryParents() {
...
static int putRange(Map<String, Integer> map, int start, String... itemIds) {
    int order = start;
...
static SfxItemCategory category(String id, String legacyName, ItemStack icon, int order) {
    return new SfxItemCategory(id, Text.legacy(legacyName), icon, order, false);
}

static ItemStack icon(Material material, String legacyName, String textureHash, Integer colorRgb) {
