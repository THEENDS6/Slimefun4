...
/**
 * Single break/destruction router for anchored SFX blocks.
 *
 * <p>Before this class, SfxPlaceableBlockListener owned the entire destroy if/else tree. Keeping
 * the route here means the listener only translates Bukkit events; block lifecycle ownership lives
 * in the framework layer.</p>
 */
