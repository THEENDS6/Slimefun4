...
/**
 * Framework placement router for anchored SFX blocks.
 *
 * <p>The Bukkit listener should not own the domain placement decision tree. This router owns
 * marker validation, android skull redirection, domain-specific afterPlace initialization, and
 * framework runtime state registration.</p>
 */
