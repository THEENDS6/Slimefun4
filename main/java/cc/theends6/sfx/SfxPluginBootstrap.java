...
/**
 * Owns the heavy SlimeFunX boot/shutdown dependency graph.
 *
 * <p>The plugin entry class intentionally keeps only Bukkit lifecycle forwarding; service construction,
 * framework catalog binding, listener registration and shutdown ordering live here so future modules can be
 * split without growing {@link SlimeFunXPlugin} again.</p>
 */
