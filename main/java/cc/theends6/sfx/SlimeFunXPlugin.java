...
public final class SlimeFunXPlugin extends JavaPlugin {
    ...
    private void cancelScheduledRuntimeTasks(String reason) {
        ...
        try {
            ...
            // Paper's public RegionScheduler API may not expose plugin-wide cancellation.
            // Region tasks scheduled by this plugin still guard their own running flags on shutdown.
        } catch (Throwable throwable) {
